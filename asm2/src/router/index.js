...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/EventmodifyView.vue')
    },
    {
...

    {
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/EventoverallView.vue')
    },
    {
    ...
    },
    {
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/SearchmulView.vue')
    },
    {
      path: '/volunteers',
      name: 'list',
    ...
    },
    {
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/VolunteermodView.vue')
    },
    {
      path: '/',
      name: 'home',
